...
from app.schemas.analyses import AnalysisListItem
from streamlit_app.api import delete_analysis, fetch_analyses, fetch_analysis
...
def render_analysis_detail(analysis_id: int) -> bool:
    ...
    if analysis.status == "failed":
        ...
        render_fit_result(analysis.result.model_dump(mode="json"), analysis_id=analysis_id)
    return go_back
